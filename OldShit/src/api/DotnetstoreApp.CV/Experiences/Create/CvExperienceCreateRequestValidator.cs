...
namespace DotnetstoreApp.CV.Experiences.Create;

internal sealed class CvExperienceCreateRequestValidator : AbstractValidator<CvExperienceCreateRequest>
{
    public CvExperienceCreateRequestValidator()
    {
        RuleFor(x => x.CvId)
